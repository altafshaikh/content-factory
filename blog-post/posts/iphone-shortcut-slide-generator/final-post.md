---
title: I Stopped Writing Slides. I Started Shipping Notes.
tags: productivity, automation, ai, ios-shortcuts, prompt-engineering
seo_title: Turn Raw Notes Into Slides Automatically With an iPhone Shortcut
seo_description: Stuck turning raw notes into a real slide deck? Here's how a one-tap iPhone Shortcut and a fixed AI prompt removed the friction for good.
---
...
PROMPT:
A wide dark editorial illustration showing a chaotic scatter of loose scribbled notes and torn paper fragments on the left side, flowing through a single glowing point of contact in the center, and emerging on the right as a neat, evenly-aligned stack of clean rectangular cards. Minimal, tech-editorial style, deep charcoal background, one warm accent color for the point of contact and the clean cards. Sense of calm transformation, not chaos-to-chaos. Wide banner format, 16:9 aspect ratio.
